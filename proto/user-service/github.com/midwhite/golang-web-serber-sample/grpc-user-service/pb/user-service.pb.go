...
func (x *GetUserDetailParams) Reset() {
	*x = GetUserDetailParams{}
...
func (x *GetUserDetailParams) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetUserDetailParams) ProtoMessage() {}

func (x *GetUserDetailParams) ProtoReflect() protoreflect.Message {
	mi := &file_user_service_user_service_proto_msgTypes[0]
...
// Deprecated: Use GetUserDetailParams.ProtoReflect.Descriptor instead.
func (*GetUserDetailParams) Descriptor() ([]byte, []int) {
	return file_user_service_user_service_proto_rawDescGZIP(), []int{0}
}

func (x *GetUserDetailParams) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
var file_user_service_user_service_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x02, 0x70, 0x62, 0x22, 0x25, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72,
	0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x12, 0x0e, 0x0a, 0x02,
	0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x22, 0x42, 0x0a, 0x0a,
	...
	,
...
var file_user_service_user_service_proto_goTypes = []interface{}{
	(*GetUserDetailParams)(nil), // 0: pb.GetUserDetailParams
	(*UserDetail)(nil),          // 1: pb.UserDetail
}
var file_user_service_user_service_proto_depIdxs = []int32{
	0, // 0: pb.UserService.GetUserDetail:input_type -> pb.GetUserDetailParams
	1, // 1: pb.UserService.GetUserDetail:output_type -> pb.UserDetail
...
func file_user_service_user_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_user_service_user_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetUserDetailParams); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type UserServiceClient interface {
	GetUserDetail(ctx context.Context, in *GetUserDetailParams, opts ...grpc.CallOption) (*UserDetail, error)
}
...
func (c *userServiceClient) GetUserDetail(ctx context.Context, in *GetUserDetailParams, opts ...grpc.CallOption) (*UserDetail, error) {
	out := new(UserDetail)
	err := c.cc.Invoke(ctx, "/pb.UserService/GetUserDetail", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	GetUserDetail(context.Context, *GetUserDetailParams) (*UserDetail, error)
}
...
func (*UnimplementedUserServiceServer) GetUserDetail(context.Context, *GetUserDetailParams) (*UserDetail, error) {
...
func _UserService_GetUserDetail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.UserService/GetUserDetail",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetUserDetail(ctx, req.(*GetUserDetailParams))
	}
